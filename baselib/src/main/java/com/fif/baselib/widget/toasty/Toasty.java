package com.fif.baselib.widget.toasty;
...
public class Toasty {
    public static String TOAST_COLOR = "#FF0090ff";
    @ColorInt
    private static int DEFAULT_TEXT_COLOR = Color.parseColor("#FFFFFF");
    @ColorInt
    private static int ERROR_COLOR = Color.parseColor(TOAST_COLOR);
    @ColorInt
    private static int INFO_COLOR = Color.parseColor(TOAST_COLOR);
    @ColorInt
    private static int SUCCESS_COLOR = Color.parseColor(TOAST_COLOR);  //渐变色 ：#016afc----#05c7f3
    @ColorInt
    private static int WARNING_COLOR = Color.parseColor(TOAST_COLOR);
    @ColorInt
    private static int NORMAL_COLOR = Color.parseColor(TOAST_COLOR);
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        if (shouldTint)
            ...
            drawableFrame = ToastyUtils.getDrawable(context, R.drawable.shape_corner_toasty);
        ToastyUtils.setBackground(toastLayout.findViewById(R.id.toast_root), drawableFrame);

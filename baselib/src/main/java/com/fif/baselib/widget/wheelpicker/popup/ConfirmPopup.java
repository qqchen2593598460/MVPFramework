package com.fif.baselib.widget.wheelpicker.popup;
...
import com.fif.baselib.utils.ConvertUtil;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected int topLineColor = 0xFF0090ff;
    ...
    protected int cancelTextColor = 0xFF0090ff;
    protected int submitTextColor = 0xFF0090ff;
    protected int titleTextColor = Color.BLACK;
    protected int pressedTextColor = 0XFF189484;
    ...
    protected View makeHeaderView() {
        ...
        int height = ConvertUtils.dp2px(topHeight);
        ...
        int padding = ConvertUtils.dp2px(topPadding);

package com.fif.baselib.widget.wheelpicker.widget;
...
import com.fif.baselib.widget.wheelpicker.entity.WheelItem;
...
public class WheelView extends View {
    ...
    //主色调
    public static final int TEXT_COLOR_FOCUS = 0xFF0090ff;
    public static final int TEXT_COLOR_NORMAL = 0XFFBBBBBB;
    public static final int DIVIDER_COLOR = 0xFF0090ff;
    ...
    public void setPadding(int padding) {
        this.padding = ConvertUtils.dp2px(padding);
    }
    ...
    private void remeasure() {
        ...
        if (useWeight) {
            ...
            if (padding < 0) {
                padding = ConvertUtils.dp2px(ITEM_PADDING);
            }

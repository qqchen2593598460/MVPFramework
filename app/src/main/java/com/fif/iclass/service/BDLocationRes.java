package com.fif.iclass.service;
...
/**
 * Created by chen on 2017-06-26. 获取当前经纬度坐标
 */

public class BDLocationRes {
    ...
    public BDLocationListener getBDLocationListener(){
            ...
            bdLocationListener = new BDLocationListener() {
                ...
                public void onReceiveLocation(BDLocation location) {
                    ...
                    if (null != location && location.getLocType() != com.baidu.location.BDLocation.TypeServerError) {
    ...
    /**
     * 传入textview，一旦定位成功，将信息保存在textview中
     */
